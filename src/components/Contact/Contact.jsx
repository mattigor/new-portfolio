    ...
    return (
        <section id="contact-me">
            <article>
                ...
                <p>Aqui estão minhas redes sociais e meu e-mail.</p>
                <hr />
                <div id="contact-me-article-social">
                    <div className="contact-me-article-social-icon">
                        <a href="https://github.com/mattigor" rel="noopener noreferrer" target="_blank">
                    ...
                    <div className="contact-me-article-social-icon">
                        <a href="https://www.linkedin.com/in/mattigor/" rel="noopener noreferrer" target="_blank">
